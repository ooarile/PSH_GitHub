	...
	public partial class TimeControl : UserControl
	{
		...
		public static readonly DependencyProperty HoursProperty =
			DependencyProperty.Register("Hours", typeof(int), typeof(TimeControl),
				new FrameworkPropertyMetadata(DateTime.Now.TimeOfDay.Hours, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, new PropertyChangedCallback(OnTimeChanged)));
		...
		public static readonly DependencyProperty MinutesProperty =
			DependencyProperty.Register("Minutes", typeof(int), typeof(TimeControl),
				new FrameworkPropertyMetadata(DateTime.Now.TimeOfDay.Minutes, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, new PropertyChangedCallback(OnTimeChanged)));
		...
		public static readonly DependencyProperty SecondsProperty =
			DependencyProperty.Register("Seconds", typeof(int), typeof(TimeControl),
				new FrameworkPropertyMetadata(DateTime.Now.TimeOfDay.Seconds, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, new PropertyChangedCallback(OnTimeChanged)));
		...
		public static readonly DependencyProperty MillisecondsProperty =
			DependencyProperty.Register("Milliseconds", typeof(int), typeof(TimeControl),
				new FrameworkPropertyMetadata(DateTime.Now.TimeOfDay.Milliseconds, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, new PropertyChangedCallback(OnTimeChanged)));
		...
		private Tuple<int, int> GetMaxAndCurentValues(String name)
		{
			...
			switch (name)
			{
				case "ff": maxValue = 1000; currValue = Milliseconds; break;
				case "ss": maxValue = 60; currValue = Seconds; break;
				case "mm": maxValue = 60; currValue = Minutes; break;
				case "hh": maxValue = 24; currValue = Hours; break;
			}
		...
		private void UpdateTimeValue(String name, int delta)
		{
			...
			switch (name)
			{
				case "ff": Milliseconds = newValue; break;
				case "ss": Seconds = newValue; break;
				case "mm": Minutes = newValue; break;
				case "hh": Hours = newValue; break;
			}
		}
