using Serilog;
//namespace Serial_protocol.DataAccess
//{
public class Logger_v2
{
    ...
    public static Serilog.ILogger Initialize(bool syncLogging, bool writeToConsole, string path, int? retainDays = null /*unlimit*/, string format = "[{Timestamp:yyyy-MM-dd}]	[{Timestamp:HH:mm:ss.fff}]	[{Level:u3}]	{Message:lj}	{SourceContext}	{NewLine}{Exception}")
    {
